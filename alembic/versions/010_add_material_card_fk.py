...
def downgrade() -> None:
    ...
    op.execute("ALTER TABLE offers DROP COLUMN IF EXISTS material_card_id")
    op.execute("ALTER TABLE sightings DROP COLUMN IF EXISTS material_card_id")
    op.execute("ALTER TABLE requirements DROP COLUMN IF EXISTS material_card_id")
