...
_CC3 = {
    "852", "853", "855", "856", "880", "886",  # HK, Macau, Cambodia, Laos, BD, TW
    "353", "354", "355", "356", "357", "358", "359",  # IE, IS, AL, MT, CY, FI, BG
    "370", "371", "372", "373", "374", "375", "376",  # LT, LV, EE, MD, AM, BY, AD
    "380", "381", "382", "383", "385", "386", "387",  # UA, RS, ME, XK, HR, SI, BA
    "420", "421",  # CZ, SK
...
_CC2 = {
    ...
    "40", "41", "43", "44", "45", "46", "47", "48", "49",  # RO, CH, AT, UK, DK, SE, NO, PL, DE
    "51", "52", "53", "54", "55", "56", "57", "58",  # PE, MX, CU, AR, BR, CL, CO, VE
    "60", "61", "62", "63", "64", "65", "66",  # MY, AU, ID, PH, NZ, SG, TH
    "70", "71", "72", "73", "74", "75", "76", "77", "78", "79",  # RU/KZ block
...
def _normalize_intl(raw: str) -> str | None:
    ...
    cleaned = re.sub(r'\s+(?:exec\s+ofc|wrong\s+no\.?\s*\w*|direct|cell|mobile|fax)\s*$', '', cleaned, flags=re.IGNORECASE)
