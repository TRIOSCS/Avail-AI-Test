...
def downgrade() -> None:
    ...
    op.execute("ALTER TABLE proactive_matches DROP COLUMN IF EXISTS dismiss_reason")
    op.execute("ALTER TABLE proactive_matches DROP COLUMN IF EXISTS our_cost")
    op.execute("ALTER TABLE proactive_matches DROP COLUMN IF EXISTS customer_last_purchased_at")
    op.execute("ALTER TABLE proactive_matches DROP COLUMN IF EXISTS customer_last_price")
    op.execute("ALTER TABLE proactive_matches DROP COLUMN IF EXISTS customer_purchase_count")
    op.execute("ALTER TABLE proactive_matches DROP COLUMN IF EXISTS margin_pct")
    op.execute("ALTER TABLE proactive_matches DROP COLUMN IF EXISTS match_score")
    op.execute("ALTER TABLE proactive_matches DROP COLUMN IF EXISTS company_id")
    op.execute("ALTER TABLE proactive_matches DROP COLUMN IF EXISTS material_card_id")
