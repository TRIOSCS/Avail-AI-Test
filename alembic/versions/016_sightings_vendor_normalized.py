...
Revision ID: 016_sightings_vendor_normalized
...
revision = "016_sightings_vendor_normalized"
...
def upgrade() -> None:
    conn = op.get_bind()
    # Widen version_num so long revision IDs (e.g. 016_sightings_vendor_normalized) fit
