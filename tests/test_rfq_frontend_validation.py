...
class TestRequirementPanelTabs:
    ...
    def test_rfq_workspace_tab_order(self, app_js):
        """RFQ workspace panel tabs match the current simplified layout."""
        import re
    ...
    def test_rfq_load_tab_handles_all_tabs(self, app_js):
        """_rfqLoadTab switch covers the current five RFQ workspace tabs."""
    ...
    def test_tasks_tab_has_create_button(self, app_js):
        """Tasks tab includes the current + Add Task button handler."""
        assert "rfqAddTask" in app_js

    def test_notes_tab_has_add_button(self, app_js):
        """Notes tab includes the current + Add Note button handler."""
