...
class TestRfqFollowUpModuleWireup:
    def test_app_imports_followups_module(self, app_js):
        assert "./rfq/followups.js" in app_js or "async function loadFollowUpsPanel()" in app_js
...
class TestRfqActivityModuleWireup:
    def test_app_imports_activity_module(self, app_js):
        assert "./rfq/activity.js" in app_js or "async function loadActivity(" in app_js
...
class TestRfqWorkspaceModuleWireup:
    def test_app_imports_workspace_module(self, app_js):
        assert "./rfq/workspace.js" in app_js or "async function _rfqLoadTab(" in app_js
...
class TestRequirementPanelTabs:
    ...
    def test_rfq_workspace_tab_order(self, app_js):
        """RFQ workspace panel tabs stay aligned with the current simplified panel."""
        import re
    ...
    def test_rfq_load_tab_handles_all_tabs(self, app_js):
        """_rfqLoadTab switch covers the active simplified workspace tabs."""
    ...
    def test_rfq_render_tab_handles_all_tabs(self, app_js):
        """_rfqRenderTab dispatches to the current five renderers."""
    ...
    def test_inline_part_expand_tabs(self, app_js):
        """Inline part expansion includes all five active tab buttons."""
        for tab in ['data-tab="offers"', 'data-tab="tasks"', 'data-tab="notes"', 'data-tab="history"', 'data-tab="sightings"']:
            assert tab in app_js
