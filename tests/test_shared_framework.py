...
class TestIntakeBar:
    ...
    def test_intake_placeholder_mentions_paste(self, index_html):
        assert "Paste part numbers" in index_html or "Paste" in index_html
    ...
    def test_intake_uses_parse_text(self, app_js):
        assert "_intakeParseText" in app_js
