"""Tests for migration 125 (partsurfer_desc_negative table).
...
Called by: pytest
Depends on: alembic/versions/125_partsurfer_desc_negative.py
"""
...
_MIGRATION_PATH = os.path.join(
    os.path.dirname(__file__), "..", "alembic", "versions", "125_partsurfer_desc_negative.py"
)
_spec = importlib.util.spec_from_file_location("migration_125", _MIGRATION_PATH)
...
class TestRevisionMetadata:
    def test_revision_id(self):
        assert _mod.revision == "125_partsurfer_desc_negative"
    ...
    def test_down_revision(self):
        assert _mod.down_revision == "124_offer_status_constraint"
