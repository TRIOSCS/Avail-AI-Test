...
def site(db_session: Session, company_with_site: Company) -> CustomerSite:
    ...
    return (
        ...
        .filter(CustomerSite.company_id == company_with_site.id)
        .first()
    )
...
class TestSitesTab:
    ...
    def test_sites_tab_loads(self, client: TestClient, company_with_site: Company):
        resp = client.get(f"/v2/partials/companies/{company_with_site.id}/tab/sites")
...
class TestSiteCrud:
    ...
    def test_create_site(
        self, client: TestClient, db_session: Session, company_with_site: Company
    ):
        resp = client.post(
            f"/v2/partials/companies/{company_with_site.id}/sites",
            data={
    ...
    def test_create_site_requires_name(
        self, client: TestClient, company_with_site: Company
    ):
        resp = client.post(
            f"/v2/partials/companies/{company_with_site.id}/sites",
            data={"site_name": ""},
    ...
    def test_create_site_with_owner(
        ...
        site = (
            db_session.query(CustomerSite)
            .filter(CustomerSite.site_name == "Owned Site")
            .first()
        )
    ...
    def test_delete_site(
        ...
        resp = client.delete(
            f"/v2/partials/companies/{company_with_site.id}/sites/{site.id}"
        )
        assert resp.status_code == 200
    ...
    def test_delete_site_404(self, client: TestClient, company_with_site: Company):
        resp = client.delete(
            f"/v2/partials/companies/{company_with_site.id}/sites/99999"
        )
...
class TestSiteContacts:
    ...
    def test_load_contacts(
        ...
        resp = client.get(
            f"/v2/partials/companies/{company_with_site.id}/sites/{site.id}/contacts"
        )
        assert resp.status_code == 200
    ...
    def test_create_contact_requires_name(
        self, client: TestClient, company_with_site: Company, site: CustomerSite
    ):
        resp = client.post(
            f"/v2/partials/companies/{company_with_site.id}/sites/{site.id}/contacts",
    ...
    def test_delete_contact(
        ...
        resp = client.delete(
            f"/v2/partials/companies/{company_with_site.id}/sites/{site.id}/contacts/{site_contact.id}"
        )
        assert resp.status_code == 200
        assert resp.text.strip() == ""
    ...
    def test_delete_contact_404(
        ...
        resp = client.delete(
            f"/v2/partials/companies/{company_with_site.id}/sites/{site.id}/contacts/99999"
        )
        assert resp.status_code == 404
    ...
    def test_set_primary_contact(
        ...
        resp = client.post(
            f"/v2/partials/companies/{company_with_site.id}/sites/{site.id}/contacts/{site_contact.id}/primary"
        )
        assert resp.status_code == 200
    ...
    def test_set_primary_unsets_others(
        ...
        c1 = SiteContact(
            customer_site_id=site.id, full_name="Contact A", is_primary=True, is_active=True
        )
        c2 = SiteContact(
            customer_site_id=site.id, full_name="Contact B", is_primary=False, is_active=True
        )
        db_session.add_all([c1, c2])
        db_session.commit()

        client.post(
            f"/v2/partials/companies/{company_with_site.id}/sites/{site.id}/contacts/{c2.id}/primary"
        )
...
class TestContactsTab:
    ...
    def test_contacts_tab_shows_site_contacts(
        ...
        resp = client.get(f"/v2/partials/companies/{company_with_site.id}/tab/contacts")
        assert resp.status_code == 200
        assert "John Buyer" in resp.text
