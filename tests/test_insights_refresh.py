"""tests/test_insights_refresh.py — Regression tests for P0.1: the AI insights "Refresh"
HTMX endpoints must await the async knowledge_service generator instead of firing-and-
discarding the coroutine.

Targets: app/routers/htmx_views.py::{requisition,vendor,company}_insights_refresh
(the pipeline variant was deleted with the Dashboard page in the Wave 2 sweep)
