...
class TestBuyplanServiceFacadeImports:
    ...
    def test_import_private_builder_helpers(self):
        ...
        for fn in (_build_lines_for_requirement, _check_better_offer,
                   _check_geo_mismatch, _check_quantity_gaps, _create_line):
            assert callable(fn)
    ...
    def test_all_names_accessible_from_single_import(self):
        """Import many names in one statement — confirms the façade's __init__-style re-exports."""
        from app.services.buyplan_service import (
            build_buy_plan,
            generate_ai_flags,
            generate_ai_summary,
        ...
        names = [build_buy_plan, generate_ai_flags, generate_ai_summary,
                 log_buyplan_activity, notify_cancelled, score_offer, submit_buy_plan]
