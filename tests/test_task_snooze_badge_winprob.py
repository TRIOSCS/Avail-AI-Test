...
# TestWinProbabilityRoute removed — the win-probability inline-edit route was
# cut by the Packet-2 screen diet (w2-screen-diet.md item 1; column + model
# validation tests above stay, the column is untouched).
