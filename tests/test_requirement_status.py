...
from app.models import ActivityLog, Offer, Requirement, Requisition, User
...
class TestTransitionRequirement:
    ...
    def test_with_enum(self, db_session, test_requisition, test_user):
        ...
        changed = transition_requirement(
            req_item, RequirementSourcingStatus.offered, db_session, actor=test_user
        )
        assert changed is True
