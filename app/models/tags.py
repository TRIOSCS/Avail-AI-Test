...
class Tag(Base):
    ...
    created_at = Column(UTCDateTime(timezone=True), nullable=False, default=lambda: datetime.now(timezone.utc))
...
class MaterialTag(Base):
    ...
    classified_at = Column(UTCDateTime(timezone=True), nullable=True)
...
class EntityTag(Base):
    ...
    first_seen_at = Column(UTCDateTime(timezone=True), nullable=True)
    last_seen_at = Column(UTCDateTime(timezone=True), nullable=True)
