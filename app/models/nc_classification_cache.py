"""NetComponents classification cache model.
...
Called by: nc_worker.ai_gate (process_ai_gate)
...
class NcClassificationCache(Base):
    __tablename__ = "nc_classification_cache"
