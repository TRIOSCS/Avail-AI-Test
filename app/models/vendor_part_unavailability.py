...
from sqlalchemy import CheckConstraint, Column, ForeignKey, Index, Integer, String, Text, UniqueConstraint, func
...
class VendorPartUnavailability(Base):
    ...
    # restock override never fires (fail-closed for records created before the
    # policy-columns migration).
